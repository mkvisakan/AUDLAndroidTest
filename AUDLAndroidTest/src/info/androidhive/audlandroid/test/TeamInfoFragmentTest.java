...
public class TeamInfoFragmentTest extends android.test.ActivityInstrumentationTestCase2<MainActivity>{
	...
	public void testParseJson() throws Exception {
		String response = "[[[\"Madison\", \"Radicals\", 224002], [\"Benjy K\", \"1\"], [\"Andrew M\", \"2\"]], [\"Madison Radicals\", 224002, [\"4/12/14\", \"7:30 PM EST\", \"Cincinnati Revolution\"], [\"4/13/14\", \"3:30 PM EST\", \"Indianapolis AlleyCats\"], [\"4/19/14\", \"12:00 AM EST\", \"Detroit Mechanix\"]], [[\"Madison\", \"Radicals\", 224002], [\"Goals\", [[\"Scott R\", 42], [\"Nate T\", 36], [\"Pat S\", 36]]], [\"Assists\", [[\"Animal\", 55]]], [\"Drops\", [[\"Dave W\", 8]]], [\"Throwaways\", [[\"Dave W\", 56]]], [\"PMC\", [[\"Scott R\", 75], [\"Pat S\", 61]]], [\"Ds\", [[\"Dave W\", 28]]]]]";
		JSONArray jsonResult = new JSONArray(response);
		teamFrag.parseJSON(jsonResult); 
		TeamsListItem team = teamFrag.getTeam(); 
		...
		assertEquals("Testing the parsing of team schedule", 3, team.getSchedDateTimes().size());
		assertEquals("Testing the parsing of schedule team name", "Cincinnati Revolution", team.getSchedTeams().get(0));
		assertEquals("Testing the parsing of schedule team name", "4/12/14 7:30 PM EST", team.getSchedDateTimes().get(0));
