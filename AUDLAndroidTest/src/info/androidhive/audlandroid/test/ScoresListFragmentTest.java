...
public class ScoresListFragmentTest extends android.test.AndroidTestCase{
	...
	public void testParseJson() throws Exception{
		...
		assertTrue(scoreList.get(0).get(0).equals(new ScoreListItem("Salt Lake Lions","5094953273262080","San Jose Spiders","6597766625099776","4/20/14","1:00 PM PST","18","37","2", "null")));
	}
}
