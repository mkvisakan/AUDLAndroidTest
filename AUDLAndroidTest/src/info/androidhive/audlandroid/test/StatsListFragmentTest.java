...
public class StatsListFragmentTest extends android.test.ActivityInstrumentationTestCase2<MainActivity>{
    ...
    protected void setUp() throws Exception {
        ...
        statFrag = (StatsListFragment) mFragmentManager.findFragmentByTag("tag");
    }
